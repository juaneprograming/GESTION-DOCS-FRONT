...
const menuItems = [
  ...
  
  {
    ...
    subItems: [
      { name: "Consulta de PQRSD", url: "/pqrsd/consulta" },
      { name: "Nueva PQRSD", url: "/pqrsd/nueva" },
      { name: "Gestion de PQRSD", url: "/pqrsd/gestionpqrsd" },
      { name: "Gestion Archivo", url: "/pqrsd/gestionarchivo" },
      { name: "Informe de PQRSD", url: "/pqrsd/informe" },
      { name: "Analisis Individual", url: "/pqrsd/analisis" },
      { name: "Administrar PQRSD", url: "/pqrsd/administrarpqrsd" },
      { name: "Parametricas", url: "/pqrsd/parametricas" },      
    ],
  },
  {
    name: "Administracion",
