                            ...
                            <Tabs defaultValue="solicitud" className="w-full">
                                ...
                                <TabsContent value="solicitud" className="space-y-4 mt-6">
                                    <div className="flex justify-between items-start">
                                        <h2 className="text-xl font-semibold">Solicitud N° {pqrsdData.numero_radicado || ''}</h2>
                                    </div>
                                ...
                                <TabsContent value="traza" className="mt-6">
                                    ...
                                    <div className="p-4 text-center text-muted-foreground">Contenido de la Traza</div>
                                </TabsContent>
                            </Tabs>
                        </CardContent>
                    </Card>
